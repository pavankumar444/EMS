...
CREATE TABLE `EMS_department` (
  ...
  `department_total_employees` int(11) DEFAULT 0,
  `department_description` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`department_id`),
  KEY `organization_ID_idx` (`organization_id`),
  CONSTRAINT `fk_organization_id` FOREIGN KEY (`organization_id`) REFERENCES `EMS_organization` (`organization_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2025-03-24 10:33:37
